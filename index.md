...
Building AI to automate the scientific process is one of the most important landmarks in AI research today. As language models have become increasingly capable, there has been growing interest in approaching that landmark via agentic systems. However, current paradigms often adopt rigid workflows, making it difficult to adapt components to new scientific subdomains or individual use cases.

We introduce **freephdlabor**, a multi-agent system consisting of specialized agents—each with distinct goals and tools—managed by a central ManagerAgent who delegates tasks dynamically based on research progress. Individual agents autonomously make variable numbers of tool calls and report back to the ManagerAgent, while all agents share access to a common workspace that serves both as memory and as an inter-agent communication channel.

This modular architecture enables seamless modification, addition, or removal of agents to adapt the framework to diverse domains. We also provide empirical guidelines on building upon the system to tailor it to individual research needs.
...
Here is a demo of freephdlabor at work:

<video width="720" height="480" controls>
  <source src="videos/demo.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
*Video: freephdlabor autonomously conducting AI research from ideation to publication*

[Link to example research paper PDF generated by the system](outputs/example_paper.pdf)
